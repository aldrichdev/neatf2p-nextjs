...
export const hiscoresStyles = {
  ...
  hiscoresTableClass: 'bg-background-paper w-full rounded-t-lg font-sans',
  ...
  hiscoresMenuItem: (isSelected: boolean) =>
    clsx(
      ...
      isSelected
        ...
        : 'text-text-primary border-divider bg-background-paper font-normal',
      'md:text-text-primary md:w-auto md:gap-2 md:rounded-none md:border-0 md:px-3.5 md:py-1.75 md:text-left',
      isSelected
  ...
  npcHiscoresMenuItem: (isSelected: boolean) =>
    clsx(
      ...
      isSelected
        ? 'text-table-header-text border-primary-main bg-primary-main font-medium'
        : 'text-text-primary border-divider bg-background-paper font-normal',
      'lg:text-text-primary lg:w-auto lg:gap-2 lg:rounded-none lg:border-0 lg:px-3.5 lg:py-1.75 lg:text-left',
      isSelected
