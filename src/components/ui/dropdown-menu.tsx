  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        align={align}
        className={cn(
          'bg-popover text-popover-foreground ring-foreground/10 z-50 rounded-md p-1 shadow-md ring-1 duration-100',
...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        'group/dropdown-menu-item relative flex cursor-default items-center gap-2 rounded-sm px-2 py-1.5 text-sm',
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        'bg-popover text-popover-foreground ring-foreground/10 z-50 min-w-24 rounded-md p-1 shadow-lg ring-1 duration-100',
