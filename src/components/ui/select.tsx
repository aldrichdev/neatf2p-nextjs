...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        'border-input flex w-fit items-center justify-between gap-1.5 rounded-md border bg-transparent',
        'py-2 pr-2 pl-2.5 text-sm whitespace-nowrap shadow-xs transition-[color,box-shadow] outline-none',
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          'bg-popover text-popover-foreground ring-foreground/10 relative z-50 min-w-36 rounded-md shadow-md ring-1',
