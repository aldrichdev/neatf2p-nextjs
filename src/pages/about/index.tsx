...
const About = () => (
  <ContentBlock>
    ...
    <Paragraph variant="body">
      Neat F2P is a F2P-only, 1x EXP, mostly-authentic RuneScape Classic private server that runs on the Open RSC framework.
      This is F2P in RuneScape as it was in 2002-2003, just without members content. Of course, it is actually free 
      to play - no credit card required.
    </Paragraph>
    <Paragraph variant="body">
    ...
    <Paragraph variant="body">
      So, <Link href="/how-to-play" target="_blank">jump in today</Link> and experience what a F2P-only economy can be!
    </Paragraph>
  </ContentBlock>
)
